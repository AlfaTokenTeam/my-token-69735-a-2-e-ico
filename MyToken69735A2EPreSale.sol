...
import "./MyToken69735A2E.sol";

contract MyToken69735A2EPreSale {
    MyToken69735A2E public token;
    ...
    function MyToken69735A2EPreSale(
        MyToken69735A2E _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken69735A2E(_token);
